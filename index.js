...
const UUID = process.env.UUID || '85c07fa0-f98a-42e3-9828-478e9a43913b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'yniulevps20260421sub';            // 获取节点的订阅路径
